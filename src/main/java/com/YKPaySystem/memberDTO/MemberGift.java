...
public class MemberGift {
	...
	public MemberGift(String userId, String phoneNumber, int totalpoint, String productName, int productPrice,
			String productCode, String productBarcode, int amount, int pointSum, int pointRemain, String regdate) {
		super();
		this.userId = userId;
		this.phoneNumber = phoneNumber;
		this.totalpoint = totalpoint;
